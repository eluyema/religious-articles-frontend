...
export default function Page() {
  const [hasSentError] = useState(false);
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://jesusnear.sentry.io/issues/?project=4509395784040448">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            await Sentry.startSpan({
              ...
              throw new Error("Detected super K K K (Triple K) !!!")
            });
          }}
        >
          <span>
